...
public:
	...
	virtual const char* Key_BindingForKey( uint& code ) = 0;

	// key trapping (for binding keys)
	virtual void				StartKeyTrapMode( void ) = 0;
	virtual bool				CheckDoneKeyTrapping( uint& code ) = 0;
	...
	virtual void		DebugDrawPhysCollide( const CPhysCollide* pCollide, IMaterial* pMaterial, void*& transform, const uint& color ) = 0;
...
public:
	...
	virtual int				IN_KeyEvent( int eventcode, uint keynum, const char* pszCurrentBinding ) = 0;
	...
	// Matchmaking
	virtual void			SetupGameProperties( CUtlVector< void* >& contexts, CUtlVector< void* >& properties ) = 0;
