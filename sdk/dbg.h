...
//
// Purpose: Minimalized version of the standard 2007 dbg.h
//
// $NoKeywords: $
//
//=============================================================================//
...
#define DLL_GLOBAL_IMPORT	__declspec( dllimport )
...
DLL_IMPORT double Plat_FloatTime();
...
private:
	union {
		...
		unsigned int _color32;
	};
public:
	Color() : _color32(0) {}
	Color(int color) : _color32(color) {}
	Color(int r, int g, int b) : _color32(0) {
		SetColor(r, g, b, 255);
	}
	Color(int r, int g, int b, int a) : _color32(0) {
		SetColor(r, g, b, a);
	}
	...
	unsigned int GetColor() const { return _color32; }
};
