...
public:
	...
	virtual bool			GetSessionRecordBuffer( uint8_t **ppSessionBuffer, int *pSize ) = 0;
...
public:
	...
	virtual uint32_t			GetClientSteamID() = 0;
	virtual void			Con_NPrintf( int nPos, const char *pFormat, ... ) = 0;
